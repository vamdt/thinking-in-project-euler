...
def product(indexs, numbers)
  indexs.reduce(1) {|pr, n| pr * numbers[n] } 
end

def max_product_of_numbers(numbers)
  max = 0
...
puts max_product_of_numbers numbers(digits_text)